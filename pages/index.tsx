...
const LatestByReviews = withFetchedGameData(ReviewSuccesses, `${domain}/wp-json/public/game/get?itemCount=30&mode=latest-by-reviews`, `Virhe ladattaessa pelejä`)
const WorthMention = withFetchedGameData(PreviouslyUpdatedGames, `${domain}/wp-json/public/game/get?itemCount=30&mode=worth-mention`, `Virhe ladattaessa pelejä`)  
